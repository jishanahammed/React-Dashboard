...
const demoInstallations = [
    { id: 1, name: 'Installation 1', installationsType: 'Residential Installation', rate: '200', unit: 'Hours', region: 'North', description: 'Description 1' },
    { id: 2, name: 'Installation 2', installationsType: 'Commercial Installation', rate: '350', unit: 'Days', region: 'South', description: 'Description 2' },
];
                    ...
                    <table className="min-w-full bg-white border border-gray-300">
                        <thead>
                            <tr>
                                ...
                                <th className="border p-2 text-left">Installation Type</th>
                        ...
                        <tbody>
                            {installationsList.map((installation, index) => (
                                <tr key={installation.id}>
                                    ...
                                    <td className="border p-2">{installation.installationsType}</td>
                    ...
                    <div className="bg-white rounded-lg w-full sm:w-96 md:w-[32rem] lg:w-[40rem]">
                        ...
                        <div className="p-5">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    <select
                                        name="installationsType"
                                        value={formData.installationsType}
                                        onChange={handleInputChange}
                                        className="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition"
                                        required
                                    >
                                        <option value="" disabled>Select Installation Type</option>
                                        {installationsTypes.map((type) => (
